...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $staticPage = (new StaticPagesController())->create($name, $slug, $content);
                ...
                <section class="content">
                    <div class="box">
                        <div class="card-header pb-0 d-flex justify-content-between">
                            <h3 class="box-title">New Static Page</h3>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <form class="form" method="POST" action="">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="content" id="content" placeholder="Page content"></textarea>
                                    </div>
                                </div>
                                <!-- /.box-body -->
