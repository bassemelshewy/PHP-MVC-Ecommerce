                ...
                <div class="col-12">
                    <div class="box">
                        <div class="card-header pb-0 d-flex justify-content-between">
                            ...
                            <a href="add_category.php" class="btn btn-info btn-sm">
                                Add Category
                            </a>
                        </div>
                        <!-- /.box-header -->
                                                ...
                                                <th>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable" data-popper-placement="top-start">
                                                            <li><a class="dropdown-item border-radius-md text-warning" href="edit_category.php?id=<?php echo $category['id'] ?>">Edit</a></li>
                                                            <li>
                                                                <form method="POST" action="delete_category.php?id=<?php echo $category['id'] ?>"
